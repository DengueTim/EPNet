...
class FlowNetPwcLite2xA(nn.Module):
    """
    ...
    def __init__(self, md=4):
        ...
        md2plus1 = md * 2 + 1
        self.corr6 = SpatialCorrelationSampler(patch_size=md2plus1, kernel_size=1, stride=1)
        md2plus1N = (md-1) * 2 + 1
        self.corrN = SpatialCorrelationSampler(patch_size=md2plus1N, kernel_size=1, stride=1)
